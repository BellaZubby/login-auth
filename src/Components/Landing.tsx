...
const Landing = () => {
  ...
  return (
    <section>
      <div className='bg-gray-20 h-screen w-full flex flex-col items-center justify-center'>

        <h1 className='font-montserrat text-4xl font-bold text-black'>WELCOME</h1>

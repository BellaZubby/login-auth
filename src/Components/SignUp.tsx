                ...
                <div className='my-16 border px-6 py-9 rounded-sm border-gray-100 w-5/6 mx-auto sm:w-[50%] md:w-[30%] bg-white main'>
                    ...
                    >
                        ...
                        <div className='relative'>
                            <input
                                className='mb-5 w-full bg-transparent border border-1 px-5 py-3 placeholder:text-gray-20 border-gray-300 placeholder:font-sm text-black'
                            ...
                            />
                            {!shown ? <EyeIcon onClick={visibility} className='absolute w-6 h-6 top-3.5 right-4 text-gray-400'></EyeIcon> :
                                <EyeSlashIcon onClick={visibility} className='absolute w-6 h-6 top-3.5 right-4 text-gray-400'></EyeSlashIcon>
                            }
                        </div>
                        {
                            errors.password && (
                        ...
                        <div className='relative'>
                            <input
                                className='mb-5 w-full bg-transparent border border-1 px-5 py-3 placeholder:text-gray-20 border-gray-300 placeholder:font-sm text-black relative'
                                type={shown ? "text" : "password"}
